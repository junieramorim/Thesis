...
\draw  [color={rgb, 255:red, 53; green, 71; blue, 31 }  ,draw opacity=1 ][line width=1.5]  (207.5,28) .. controls (207.5,16.95) and (216.45,8) .. (227.5,8) -- (309.5,8) .. controls (320.55,8) and (329.5,16.95) .. (329.5,28) -- (329.5,88) .. controls (329.5,99.05) and (320.55,108) .. (309.5,108) -- (227.5,108) .. controls (216.45,108) and (207.5,99.05) .. (207.5,88) -- cycle ;
...
% Text Node
\draw (140,191) node    {$EX$};
% Text Node
\draw (111.33,152.33) node    {$c_{1}$};
% Text Node
\draw (174.67,148) node    {$m$};
% Text Node
\draw (127.33,64.33) node    {$c_{2}$};
% Text Node
\draw (267.5,55.5) node    {$ \begin{array}{l}
Cap( c_{1})  >0\\
Cap( c_{2}) =0\\
Cap( m)  >0\\
Cap( fb) \  >\ 0
