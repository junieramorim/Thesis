...
%uncomment if require: \path (0,775); %set diagram left start at 0, and has height of 775
...
\draw   (111,586.6) .. controls (111,561.97) and (130.97,542) .. (155.6,542) -- (575.4,542) .. controls (600.03,542) and (620,561.97) .. (620,586.6) -- (620,720.4) .. controls (620,745.03) and (600.03,765) .. (575.4,765) -- (155.6,765) .. controls (130.97,765) and (111,745.03) .. (111,720.4) -- cycle ;
%Rounded Rect [id:dp07131134126212679] 
\draw   (106,487.4) .. controls (106,481.1) and (111.1,476) .. (117.4,476) -- (609.6,476) .. controls (615.9,476) and (621,481.1) .. (621,487.4) -- (621,521.6) .. controls (621,527.9) and (615.9,533) .. (609.6,533) -- (117.4,533) .. controls (111.1,533) and (106,527.9) .. (106,521.6) -- cycle ;
...
% Text Node
\draw (487,84) node    {$alloc=[] :c_{3} !\langle T',E'\rangle $};
% Text Node
...
% Text Node
\draw (367,661) node    {$ \begin{array}{l}
...
Effect( ping,\eta ) =\eta [ \ \langle T',E'\rangle :=teamStatus( E') \ ]\\
\end{array}$};
% Text Node
...
% Text Node
\draw (361.76,502) node    {$ \begin{array}{l}
g_{0} :=( T'=[]) \ \land ( f\_alloc\ =\ f_{x}([ t_{1} ,\ ...,t_{n}] \ p_{1} ,\ [ e_{1} ,...,e_{n}] \ p_{2}))\\
